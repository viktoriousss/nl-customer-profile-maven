...
```json
{
  "projectName" : "nl-java-rest-service-maven",
  "artifactId" : "nl-customer-profile-maven",
  "groupId" : "com.example",
  ...
  "databaseName" : "customer-database-maven",
...
┃ ┃ ┃ Debug Adding symbol workloadResourceName with value 'nl-customer-profile-maven'
┃ ┃ ┃ Debug Adding symbol databaseResourceName with value 'customer-database-maven'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#exposeOpenAPIEndpoint) evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [DESCRIPTION_VAL->Manage customer prof...(truncated), OWNER_VAL->dutch-team, SYSTEM_VAL->profile-management]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [customer-database->customer-database-ma...(truncated), rest-service-db->nl-customer-profile-...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [my-project->nl-customer-profile-...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [rest-service-db->nl-customer-profile-...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [customer-database->customer-database-ma...(truncated)]
